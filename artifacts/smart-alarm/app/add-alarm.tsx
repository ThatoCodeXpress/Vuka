  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { paddingTop: topInset + 16 }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.foreground }]}>New Alarm</Text>
        <TouchableOpacity
      ...
      >
                  ...
                  >
                    <Text
                      style={[
                        ...
                        { color: h === hour ? colors.primaryForeground : colors.foreground },
                      ]}
                    >
                ...
                {MINUTES.filter((m) => m % 5 === 0).map((m) => (
                  ...
                  >
                    <Text
                      style={[
                        styles.pickerItemText,
                        { color: m === minute ? colors.primaryForeground : colors.foreground },
                      ]}
                    >
        ...
        <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <TextInput
            ...
            placeholder="e.g. Morning alarm, Work day"
            ...
            {DAYS.map((d, i) => (
              ...
              >
                <Text
                  style={[
                    styles.dayBtnText,
                    { color: repeatDays.includes(i) ? colors.primaryForeground : colors.foreground },
                  ]}
                >
                  {d[0]}
                </Text>
                ...
                >
                  <Text
                    style={[
                      ...
                      { color: secondaryInterval === v ? colors.primaryForeground : colors.foreground },
                    ]}
                  >
                    {v}m
                  </Text>
        ...
        <View style={[styles.infoBox, { backgroundColor: colors.primary + "15" }]}>
          ...
          <Text style={[styles.infoText, { color: colors.primary }]}>
            The verification object and activity are randomly selected from your library each morning, preventing cheating.
          </Text>
        </View>
      </ScrollView>
    </View>
